                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-8 col-md-8 col-12 ms-auto">
                            <div className="section-title-wrap d-flex justify-content-center align-items-center mb-4">
                                <img src="https://templatemo.com/templates/templatemo_578_first_portfolio/images/white-desk-work-study-aesthetics.jpg" className="avatar-image img-fluid" alt="abs"/>
                        ...
                        <div className="col-lg-4 col-md-6 col-12">
                            <div className="projects-thumb">
                                ...
                                <a href="images/projects/nikhil-KO4io-eCAXA-unsplash.jpg" className="popup-image">
                                    <img src="https://templatemo.com/templates/templatemo_578_first_portfolio/images/projects/nikhil-KO4io-eCAXA-unsplash.jpg" className="projects-image img-fluid" alt="abs"/>
                                </a>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-4 col-md-6 col-12">
                            <div className="projects-thumb">
                                ...
                                <a href="images/projects/the-5th-IQYR7N67dhM-unsplash.jpg" className="popup-image">
                                    <img src="https://templatemo.com/templates/templatemo_578_first_portfolio/images/projects/the-5th-IQYR7N67dhM-unsplash.jpg" className="projects-image img-fluid" alt="abs"/>
                                </a>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-4 col-md-6 col-12">
                            <div className="projects-thumb">
                                ...
                                <a href="images/projects/true-agency-9Bjog5FZ-oc-unsplash.jpg" className="popup-image">
                                    <img src="https://templatemo.com/templates/templatemo_578_first_portfolio/images/projects/true-agency-9Bjog5FZ-oc-unsplash.jpg" className="projects-image img-fluid" alt="abs"/>
                                </a>
                            </div>
                        </div>
