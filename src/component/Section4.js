                ...
                <div className="row">
                    ...
                    <div className="col-lg-10 col-12 mx-auto">
                        <div className="section-title-wrap d-flex justify-content-center align-items-center mb-5">
                            <img src="https://templatemo.com/templates/templatemo_578_first_portfolio/images/handshake-man-woman-after-signing-business-contract-closeup.jpg" className="avatar-image img-fluid" alt="abs"/>

                            <h2 className="text-white ms-4 mb-0 fs-1">Services</h2>
                        </div>

                        <div className="row pt-lg-5 mx-5">
                            <div className="col-lg-6 col-12">
                                <div className="services-thumb">
                                    ...
                                    <div className="services-icon-wrap d-flex justify-content-center align-items-center">
                                        ...
                                        <i className="services-icon bi bi-globe"></i>
                                    </div>
                                </div>
                            </div>
